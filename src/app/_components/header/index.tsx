...
export function Header() {
  return (
    <header className=" top-4 z-40 w-full p-3">
      <div className="content-container m-auto flex items-center justify-between rounded-xl border-0 border-neutral-200/50 bg-neutral-50/80 p-0 backdrop-blur-xl transition-all dark:border-neutral-900 dark:bg-neutral-1000/80 md:px-5">
        <Link
          href="/"
